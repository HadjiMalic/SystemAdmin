...
<head>
    ...
    <style>
        ...
        .sidebar {
    width: 240px; /* Adjusted width to match the image */
    height: 100vh;
    background-color: #0e1734; /* Dark navy color to match the image */
    position: fixed;
    top: 0;
    padding-top: 20px;
    color: #f1a10b; /* Bright text color to match */
}

.sidebar a {
    padding: 15px 25px; /* More padding to match the spacing */
...
.sidebar a:hover {
    background-color: #f1a10b; /* Change background on hover */
    color: #0e1734; /* Invert text color on hover */
...
.sidebar .sidebar-header::before {
    ...
    display: block;
    height: 2px;
    background-color: #f1a10b; /* Separator under header */
    margin: 10px 0;
}
        .main-content {
            margin-left: 250px;
...
<body>
    ...
    <a href="dashboard.php"><i class='fas fa-bullhorn'></i> Announcements</a>
    <a href="events.php"><i class='bx bx-calendar'></i> Events</a>
    <a href="index.php"><i class='bx bx-check'></i> Log Out</a>
    </div>
